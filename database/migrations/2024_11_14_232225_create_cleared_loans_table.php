...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('cleared_loans', function (Blueprint $table) {
            ...
            $table->enum('loan_status', ['Pending', 'Active', 'Rejected', 'Cleared', 'Defaulted'])->default('Cleared');
    ...
    {
        Schema::dropIfExists('cleared_loans');
    }
};
